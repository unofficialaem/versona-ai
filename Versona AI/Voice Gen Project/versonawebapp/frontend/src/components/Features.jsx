...
export default function Features() {
  const items = [
    ...
    { title: "Voice Cloning", subtitle: "Clone a voice from pre-trained voices", Icon: SparkIcon },
          ...
          <div className="relative px-6 py-14 sm:px-10 sm:py-16">
            ...
            <div className="text-center">
              <h2 className="text-[36px] sm:text-[46px] md:text-[56px] font-semibold leading-[1.08] tracking-tight text-white">
                ...
                <span className="bg-gradient-to-r from-[#F3E8FF] via-[#C4B5FD] to-[#7C3AED] bg-clip-text text-transparent">
                  Creation
                </span>
              </h2>

              <p className="mx-auto mt-4 max-w-3xl text-base sm:text-lg text-white/60 leading-relaxed">
                A focused toolkit for Urdu voice generation — built for clarity, realism, and expressive audio output.
              </p>
            </div>
                  ...
                  >
                    ...
                    <div
                      className="
                        ...
                        group-hover:shadow-[0_0_55px_rgba(139,92,246,0.45)]
                    ...
                    {/* Title */}
                    <div className="mt-4 text-sm font-semibold text-white/85 group-hover:text-white transition tracking-[0.01em]">
                      {it.title}
                    </div>
