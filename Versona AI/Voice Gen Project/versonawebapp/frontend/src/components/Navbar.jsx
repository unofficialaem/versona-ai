...
export default function Navbar() {
  ...
  <div className="relative h-6 w-6">
    ...
    {/* subtle glow */}
    <div className="absolute inset-0 rounded-full bg-iris-500/20 blur-md opacity-0 group-hover:opacity-100 transition" />
  </div>

  {/* Brand name */}
  <span className="text-sm font-semibold tracking-[0.12em] lowercase bg-gradient-to-r from-white via-[#c4b5fd] to-[#8b5cf6] bg-clip-text text-transparent">
    versona
  </span>
